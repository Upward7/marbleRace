...
// Three.js and React Three Fiber handle the encoding of the colors different
// sometimes the encoding isn't set right
// 停用颜色管理中的旧模式
...
export function BlockEnd({ position=[0, 0, 0]})
{
    ...
    return <group position={position}>
        ...
        {/* Floor */}
        {/* move the floor up a little to create a better separation */}
...
export function Level({count = 5, types= [BlockSpinner, BlockAxe, BlockLimbo]}, seed = 0)
{
    ...
    return <>
        ...
        { blocks.map((Block, index) => <Block key={index} position={ [0, 0, - (index + 1) * 4] }></Block>)}
